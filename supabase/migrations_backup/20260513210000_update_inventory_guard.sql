-- =========================================================
-- Phase 1.1 — Inventory Guard Update (fn_decrement_inventory)
-- Provides helpful error messages while maintaining the 'INSUFFICIENT_STOCK'
-- tag for frontend catching.
-- =========================================================
